...
public class output {
    public static void main(String[] args) {
        ...
        for (int j = 0; j < posblsoultion.size(); j+=2) {
            ...
            System.out.println(" ");
            int i = 0;
        for (double double1 : u1.decider(9)) {
            float f1 = (float)double1;
            if(i==0){ 
            System.out.println("optimal speed "+f1);
                i++;
            }else
            {
                System.out.println("optimal angle "+f1);
            }
        }
        // for (double d1 : u1.get_velocity_and_angle(14.1, Math.toRadians(30.7), 9)) {
